...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtCedula.setFont(new Font("Roboto", Font.PLAIN, 16));
		txtCedula.setBounds(560, 85, 285, 33);
		...
		txtNombre.setBounds(560, 145, 285, 33);
		...
		txtApellido.setBounds(560, 214, 285, 33);
		...
		txtFechaN.setBounds(560, 288, 285, 36);
		...
		txtNacionalidad.setBounds(560, 360, 289, 36);
		...
		lblCedula.setBounds(562, 70, 253, 14);
		lblCedula.setForeground(SystemColor.textInactiveText);
		lblCedula.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		contentPane.add(lblCedula);

		JLabel lblNombre = new JLabel("NOMBRE");
		lblNombre.setBounds(562, 129, 253, 14);
		lblNombre.setForeground(SystemColor.textInactiveText);
		lblNombre.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		contentPane.add(lblNombre);
		
		JLabel lblApellido = new JLabel("APELLIDO");
		lblApellido.setBounds(560, 199, 255, 14);
		...
		lblNacionalidad.setBounds(560, 336, 255, 14);
		lblNacionalidad.setForeground(SystemColor.textInactiveText);
		lblNacionalidad.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		contentPane.add(lblNacionalidad);
		
		JLabel lblTelefono = new JLabel("TELÉFONO");
		lblTelefono.setBounds(562, 416, 253, 14);
		...
		txtTelefono.setBounds(560, 434, 285, 33);
		...
		lblNumeroReserva.setBounds(560, 484, 253, 14);
		...
		txtNreserva.setBounds(560, 505, 285, 33);
		...
		separator_1_2_.setBounds(560, 118, 289, 2);
		...
		separator_1_2.setBounds(560, 180, 289, 2);
		separator_1_2.setForeground(new Color(12, 138, 199));
		separator_1_2.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2);
		
		JSeparator separator_1_2_1 = new JSeparator();
		separator_1_2_1.setBounds(560, 250, 289, 2);
		separator_1_2_1.setForeground(new Color(12, 138, 199));
		separator_1_2_1.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_1);
		
		JSeparator separator_1_2_2 = new JSeparator();
		separator_1_2_2.setBounds(560, 324, 289, 2);
		separator_1_2_2.setForeground(new Color(12, 138, 199));
		separator_1_2_2.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_2);
		
		JSeparator separator_1_2_3 = new JSeparator();
		separator_1_2_3.setBounds(560, 396, 288, 2);
		separator_1_2_3.setForeground(new Color(12, 138, 199));
		separator_1_2_3.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_3);
		
		JSeparator separator_1_2_4 = new JSeparator();
		separator_1_2_4.setBounds(560, 467, 289, 2);
		separator_1_2_4.setForeground(new Color(12, 138, 199));
		separator_1_2_4.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_4);
		
		JSeparator separator_1_2_5 = new JSeparator();
		separator_1_2_5.setBounds(560, 539, 289, 2);
